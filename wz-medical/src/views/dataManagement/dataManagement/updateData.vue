  ...
  <div class="updateData-box">
    ...
    <div class="table-box">
      <el-table :data="results.list" 
        ...
        <el-table-column prop="name" label="更新数据库后名称" width="10%"/>
        <el-table-column prop="database_length" label="数据量" width="10%"/>
        <el-table-column prop="database_size" label="更新后数据库大小" width="10%"/>
        <el-table-column prop="operator" label="操作人" width="10%"/>
        <el-table-column prop="create_time" label="操作时间" width="10%"/>
        <el-table-column prop="status_name" label="是否已更新" width="10%"/>
