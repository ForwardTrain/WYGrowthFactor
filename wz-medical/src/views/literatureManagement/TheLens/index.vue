  ...
  <div class="dataManagement-box">
    ...
    <div class="table-box">
      <el-table :data="results.list" 
        ...
        <el-table-column prop="LensID" label="LensID" width="10%"/>
        <el-table-column prop="title" label="标题" width="10%"/>
        <el-table-column prop="LegalStatus" label="Legal Status" width="6%"/>
        <el-table-column prop="date_published" label="Published" width="6%"/>
        <el-table-column prop="ApplicationNumber" label="Applicants" width="10%"/>
        <el-table-column prop="inventors" label="Inventors" width="10%"/>
        <el-table-column  width="8%" align="center" label="操作">
...
import { 
  Literaturessel_TL_list,
  Literaturesdel_TL_list
} from '@/api/common'
export default {
  data () {
    return {
