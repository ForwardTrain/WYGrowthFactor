<template>
  <div class="page1-box" v-loading="loading1">
    ...
    <p class="p-2">Align multiple protein sequences with the Clustal Omega, a new multiple sequence alignment program that uses seeded guide trees and HMM profile-profile techniques to generate alignmentsbetween three or more sequences</p>
    ...
    <div class="box-1">
      ...
      <div>
        <!-- or UPI0000000001 -->
        <p>Find a protein sequence by UniProt ID (e.g. P05067 or A4_HUMAN) to align with the Clustal Omega program.You can also paste a list of IDs.</p>
    ...
    <div class="line-box3" style="margin: 20px 0;">
  ...
  methods: {
    ...
    getSequences(val) {
      ...
      this.$axios({
        ...
        this.loading = false
        this.sequences = this.sequences + res.data
     ...
     */
    opstBlast() {
      console.log(this.iterations, 222)
      this.loading1 = true
      if(!this.sequences) {
        return
      }
      ...
      formdata.append('outfmt', 'clustal_num')
      formdata.append('addformats', true)
      formdata.append('guidetreeout', true)
      if(this.order) {
      ...
      this.$axios({
        url: `${this.$global.downUrlLeft}/WZGrowth/HomeContent/runAli`,
        method: "post",
        data: formdata,
        // headers: {
